...
const Form = () => {
  ...
  return (
    <div>
      <div className="flex justify-center my-2  md:mx-0">
        <form
          name="contact"
          action="/contact"
          method="post"
        ...
        >
          ...
          <div className="flex flex-wrap -mx-3 ">
            ...
            <div className="w-full md:w-full px-3 mb-3">
              <button className="appearance-none block w-full bg-emerald-400 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-[#6055A5] focus:outline-none focus:bg-white focus:border-gray-500">
