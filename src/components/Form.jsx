        ...
        <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
          <div class="flex flex-wrap -mx-3 ">
            ...
            <div class="w-full md:w-full px-3 mb-3">
              <button class="appearance-none block w-full bg-emerald-400 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-[#6055A5] focus:outline-none focus:bg-white focus:border-gray-500">
                CLAIM YOUR FREE TRIAL
              </button>
            </div>
            <div class="mx-auto -mb-4 pb-1">
